...
<body>
	...
	<form name="joinForm" onsubmit="return checkJoin()"
		  action="validation2_pro.jsp" method="post">
	...
	<script>
		// 회원가입 유효성 검사
		function checkJoin() {
			let form = document.joinForm //name 이 joinForm 인 폼 요소 가져옴
			...
			// 1. 아이디는 필수값, 6~20자 이내
	 		...
	 		if (!passwordPattern.test(pw) ) {
	 			alert("비밀번호는 영문, 숫자, 특수문자 반드시 1글자 포함, 8글자 이상으로 입력해야합니다.")
