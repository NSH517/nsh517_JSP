 ...
 */
@WebServlet("/lifecycleservlet")		// 요청 경로 매핑
public class LifeCycleServlet extends HttpServlet {
       
    /**
     * 서블릿 최초로 생성될 때 한 번 만 호출되는 초기화 메소드
     * - 초기화 작업
     * - ServletConfig : 해당 서블릿에 대한 설정 정보를 담은 객체
     */
